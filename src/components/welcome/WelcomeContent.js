...
const WelcomeContent = () => {
  return (
    <div className="about mt-5 mb-5 container" id="about">
      ...
      <span>
        My Simple Todoapp is an app that will help you organize your work and
        life easier.
      </span>
      <span>We will keep making this app better and user friendly</span>
      ...
      <div className="contact mt-5 mb-5" id="contact">
        <div className="contact-information">
          ...
          <a>
            <img
              alt="email"
              src="https://img.icons8.com/ios-glyphs/color/40/000000/new-post.png"
            />
          ...
          <a>
            <img
              alt="instagram"
              src="https://img.icons8.com/ios-glyphs/color/40/000000/instagram-new--v1.png"
            />
          ...
          <a>
            <img
              alt="linkedin"
              src="https://img.icons8.com/ios-glyphs/40/000000/linkedin.png"
            />
